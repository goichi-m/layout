...
<div id="AjaxBatchUrl" style="display:none"><?php $bcBaser->url(array('controller' => 'layout_configs', 'action' => 'ajax_batch')) ?></div>
<div id="AlertMessage" class="message" style="display:none"></div>
<div id="DataList"><?php $bcBaser->element('layout_configs/index_list') ?></div>
